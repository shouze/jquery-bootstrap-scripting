...
(function($) {
    ...
    var Dialog2 = function(element, options) {
        ...
        this.__ajaxBeforeSerialize = $.proxy(function() {
            this.trigger("dialog2.ajax-before-serialize");
        }, handle);
        ...
        __ajaxify: function() {
            ...
            if ($.fn.ajaxForm) {
				var options = {
                    ...
                    beforeSerialize: dialog.__ajaxBeforeSerialize,
	...
	function dialogLoad(url, completeCallback, beforeSendCallback) {
		...
		jQuery.ajax({
            ...
            if (responseText.indexOf('login-form') != -1) {
